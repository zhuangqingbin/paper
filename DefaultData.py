...
data_path = os.path.join(os.getcwd(),'default of credit card clients.xls')
dtype_dicts={'SEX':object, 'EDUCATION':object, 'MARRIAGE':object, 'PAY_0':object,
             'PAY_2':object, 'PAY_3':object, 'PAY_4':object, 'PAY_5':object, 'PAY_6':object}
data = pd.read_excel(data_path,index=False,header=1,dtype=dtype_dicts).\
    rename({'default payment next month':'label'}, axis=1).drop(['ID'], axis=1)
